"""Canonical detector specification — sealed reference for behavior verification."""
...
class ReferenceStreamingAnomalyDetector:
    """Reference implementation of instruction.md contract."""
...
def result_to_dict(result: AnomalyResult) -> dict:
    return {
        ...
        "consecutive_high": result.consecutive_high,
